...
var node_youtube_music_1 = __importDefault(require("node-youtube-music"));
var spotify_web_api_node_1 = __importDefault(require("spotify-web-api-node"));
function SpotifyToYouTubeMusic(_a) {
                                        ...
                                        _loop_1 = function (i) {
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    case 0:
                                                        track = tracks[i];
                                                        return [4 /*yield*/, node_youtube_music_1.default.searchMusics("".concat(replaceTitle(replaceTitle(track.name, '('), '['), " ").concat(track.artists
...
exports.default = SpotifyToYouTubeMusic;
